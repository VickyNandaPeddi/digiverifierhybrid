...
public class Candidate implements Serializable {
	...
	@Column(name = "input_submit_date")
	private String inputSubmitDate;
	
	@Column(name = "input_submit_time")
	private String inputSubmitTime;
	
	@Column(name = "link_expire_date")
...
//	private CandidateVerificationState candidateVerificationState;
	...
	public Candidate(String candidateName, String emailId, String contactNumber, float experienceInMonth,
			String ccEmailId, String applicantId,String itrPanNumber, String uan, String recruiterName, String inputSubmitDate,
			String inputSubmitTime) {
		super();
		...
		this.inputSubmitDate= inputSubmitDate;
		this.inputSubmitTime = inputSubmitTime;
	}

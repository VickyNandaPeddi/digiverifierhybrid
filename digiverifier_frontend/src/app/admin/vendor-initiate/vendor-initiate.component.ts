...
export class VendorInitiateComponent implements OnInit {
  ...
  idItemsPassportCheck: boolean = false;
  idItemsPanORAadharORPassport: any;
  idItemsProofName: any;
  idItemsDateOfBirth: any;
  idItemsFatherName: any;
  idItemsPanORAadharORPassportRemarks: any;
  idItemsDateOfBirthRemarks: any;
  idItemsProofRemarks: any;
  idItemsModeOfVerification: any;
  idItemsVerifiedDate: any;
  idItemsAdditionalComments: any;
  idItemsAnnexureDetails: any;
  idItemsDateOfIssue: any;
  idItemsPlaceOfIssue: any;
  idItemsDateOfExpiry: any;
  idItemsDateOfIssueRemarks: any;
  idItemsPlaceOfIssueRemarks: any;
  idItemsDateOfExpiryRemarks: any;
  ...
  getsourceid(id: any) {
    ...
    if (foundItem) {
      ...
      if ((correspondingSourceName && correspondingSourceName.toLowerCase().trim().includes("Credit Check") || (this.sourceid == "89"))) {
        this.ofac = true;
        this.PhysicalVisit = false;
        this.DrugTest = false;
        this.Employments = false;
      ...
      if ((correspondingSourceName && correspondingSourceName.toLowerCase().trim().includes("Reference Verification") || (this.sourceid == "43") || (this.sourceid == "66"))) {
        this.ofac = true;
        this.PhysicalVisit = false;
        this.DrugTest = false;
        this.Employments = false;
      ...
      if ((correspondingSourceName && correspondingSourceName.toLowerCase().trim().includes("Gap Justification") || (this.sourceid == "45"))) {
        this.ofac = true;
        this.PhysicalVisit = false;
        this.DrugTest = false;
        this.Employments = false;
  ...
  triggerModal(
    ...
    if (sourceId == 5) {
      ...
      console.log("orgName : ", this.candidateDetails.candidate.organization.organizationName)

      if (this.candidateDetails.candidate.organization.organizationName == "TECHMAHINDRA LIMITED") {
        this.vendorProofForm.addControl('nameAsPerProof', new FormControl(''));
        this.vendorProofForm.addControl('nameAsPerProofRemarks', new FormControl(''));
        this.vendorProofForm.addControl('proof', new FormControl(''));
        this.vendorProofForm.addControl('proofRemarks', new FormControl(''));
        this.vendorProofForm.addControl('dateOfBirth', new FormControl(''));
        this.vendorProofForm.addControl('dateOfBirthRemarks', new FormControl(''));
        // this.vendorProofForm.addControl('fatherName', new FormControl('',[Validators.required]));
        this.vendorProofForm.addControl('modeOfVerification', new FormControl(''));
        this.vendorProofForm.addControl('verifiedDate', new FormControl(''));
        this.vendorProofForm.addControl('additionalComments', new FormControl(''));
        this.vendorProofForm.addControl('annexureDetails', new FormControl(''));

        this.vendorProofForm.addControl('dateOfIssue', new FormControl(''));
        this.vendorProofForm.addControl('placeOfIssue', new FormControl(''));
        this.vendorProofForm.addControl('dateOfExpiry', new FormControl(''));

        this.vendorProofForm.addControl('dateOfIssueRemarks', new FormControl(''));
        this.vendorProofForm.addControl('placeOfIssueRemarks', new FormControl(''));
        this.vendorProofForm.addControl('dateOfExpiryRemarks', new FormControl(''));


        if (checkType && checkType.includes('PAN')) {
          this.idItemsPanORAadharORPassport = "Name as per pan card";
          this.idItemsPanORAadharORPassportRemarks = "Name as per pan card Remarks";
          this.idItemsProofName = "Pan Card number";
          this.idItemsProofRemarks = "Pan Card number Remarks"
          this.idItemsDateOfBirth = "Date of Birth";
          this.idItemsDateOfBirthRemarks = "Date of birth Remarks";
          this.idItemsModeOfVerification = "Mode of Verification";
          this.idItemsVerifiedDate = "Verified date";
          this.idItemsAdditionalComments = "Additional Comments";
          this.idItemsAnnexureDetails = "Annexure Details"
          // this.idItemsFatherName = "Father Name";

          this.vendorProofForm.patchValue({
            'nameAsPerProof': this.candidateDetails.candidate.panName,
            'proof': this.candidateDetails.candidate.itrPanNumber,
            'dateOfBirth': this.candidateDetails.candidate.panDob,
            // 'fatherName':this.candidateDetails.candidate.aadharFatherName

          });
        }
        else if (checkType && checkType.includes('Aadhar')) {
          this.idItemsPanORAadharORPassport = "Name as per aadhar card";
          this.idItemsPanORAadharORPassportRemarks = "Name as per aadhar card Remarks";
          this.idItemsProofName = "Aadhar Card number";
          this.idItemsProofRemarks = "Aadhar Card number Remarks"
          this.idItemsDateOfBirth = "Date of birth";
          this.idItemsDateOfBirthRemarks = "Date of birth Remarks";
          this.idItemsModeOfVerification = "Mode of Verification";
          this.idItemsVerifiedDate = "Verified date";
        ...
        else if (checkType && checkType.includes('Passport')) {
          this.idItemsPassportCheck = true;
          this.idItemsPanORAadharORPassport = "Name as per Passport";
          this.idItemsPanORAadharORPassportRemarks = "Name as per Passport Remarks";
          this.idItemsProofName = "Passport number";
          this.idItemsProofRemarks = "Passport Remarks"
          this.idItemsDateOfBirth = "Date of birth";
          this.idItemsDateOfBirthRemarks = "Date of birth Remarks";
          this.idItemsModeOfVerification = "Mode of Verification";
          this.idItemsVerifiedDate = "Verified date";
          this.idItemsAdditionalComments = "Additional Comments";
          this.idItemsAnnexureDetails = "Annexure Details"
          this.idItemsDateOfIssue = "Date of Issue";
          this.idItemsDateOfExpiry = "Date of Expiry";
          this.idItemsPlaceOfIssue = "Place of Issue"
          this.idItemsDateOfIssueRemarks = "Date of Issue Remarks"
          this.idItemsPlaceOfIssueRemarks = "Place of Issue Remarks"
          this.idItemsDateOfExpiryRemarks = "Date of Expiry Remarks"
          // this.idItemsFatherName = "Father Name";
    ...
    if (this.globaldataBaseCheck === false) {
      if (this.candidateDetails.candidate.organization.organizationName == "TECHMAHINDRA LIMITED") {
        console.log("<<<<<<<<<< TECHM >>>>>>>>>>>>>>>>>>")
        this.customers
          .getVendorReportAttributesForTECHM(sourceId, this.globalCheckType)
          .subscribe((data: any) => {
            // @ts-ignore
    ...
    if (this.globaldataBaseCheck === false) {
      ...
      if (this.candidateDetails.candidate.organization.organizationName == "TECHMAHINDRA LIMITED") {
        this.customers
        .getAgentAttributesForTECHM(sourceId)
        .subscribe((data: any) => {
  ...
  onSubmit(vendorProofForm: FormGroup) {
    ...
    if (this.globaldataBaseCheck) {
      ...
      if (this.isVendorAttributeForm) {
        ...
        if (this.candidateDetails.candidate.organization.organizationName == "TECHMAHINDRA LIMITED") {
          const { vendorCheckStatusMasterId, remarks, nameAsPerProof, nameAsPerProofRemarks, proof, dateOfBirth, proofRemarks, dateOfBirthRemarks, modeOfVerification, verifiedDate, additionalComments, annexureDetails, dateOfIssue, placeOfIssue, dateOfExpiry,dateOfIssueRemarks, placeOfIssueRemarks, dateOfExpiryRemarks } = this.vendorProofForm.value;
          mergedData = {
            ...this.vendorAttributeCheckMapped,
            vendorCheckStatusMasterId,
            remarks,
            nameAsPerProof,
            nameAsPerProofRemarks,
            proof,
            dateOfBirth,
            proofRemarks,
            dateOfBirthRemarks,
      ...
      console.log("venderAttributeValue : " + formData)
